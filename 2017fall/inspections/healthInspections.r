...
### Read data from api ###
# set the limit way above the expected size of the database, to get all the data.
...
insp3 <- insp2 %>% 
  ...
  as.data.frame()
# check that expected number of rows was kept.
...
# Limit to restaurants inspected in 2017.
insp4 <- insp3 %>%
...
# All are in 2017. great.

# Look at grades assgined
